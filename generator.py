...
#            print 'New Name',zipfilenamefirstpart+version+zipfilenamelastpart
			#shutil.move(os.path.join(os.path.join(os.getcwd(),zipsfolder),zipfilenamefirstpart+zipfilenamelastpart),os.path.join(o#s.path.join(os.getcwd(),zipsfolder),zipfilenamefirstpart+version+zipfilenamelastpart))
